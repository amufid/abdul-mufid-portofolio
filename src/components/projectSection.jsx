            ...
            <div className="grid flex-col sm:grid-cols-4 justify-center pb-10 items-center">
               ...
               <AnimatedComponent>
                  <div className="rounded-md w-[310px] p-3 mx-2 my-2 shadow-xl hover:scale-105 border border-slate-500">
                     ...
                     <p className='text-sm mb-1'>With Javascript, Express.js, PostgreSQL and Next.js. This online shop website is intended to provide all baby needs.</p>
               ...
               <AnimatedComponent>
                  <div className="rounded-md w-[310px] p-3 mx-2 my-2 shadow-xl border border-slate-500 hover:scale-105">
                     ...
                     <p className=' text-sm mb-1'>With Javascript, Express.js, PostgreSQL and React.js. This website makes it easy to record all important things easily.(In development)</p>
                     <div className="flex justify-end mt-4">
               ...
               <AnimatedComponent>
                  <div className="rounded-md w-[310px] p-3 mx-2 my-2 shadow-xl border border-slate-500 hover:scale-105">
                     ...
                     <p className=' text-sm mb-1'>With Javascript, React.js and Film API. This website displays popular films and can search for film titles.</p>
                     <div className="flex justify-end mt-4">
               ...
               <AnimatedComponent>
                  <div className="rounded-md w-[310px] p-3 mx-2 my-2 shadow-xl border border-slate-500 hover:scale-105">
                     ...
                     <p className=' text-sm mb-1'>With Javascript, Express.js, MongoDB and React.js. This is a real time web chat with the socket.io library. (In development)</p>
                     <div className="flex justify-end mt-4">
               ...
               <AnimatedComponent>
                  <div className="rounded-md w-[310px] p-3 mx-2 my-2 shadow-xl border border-slate-500 hover:scale-105">
                     ...
                     <h2 className="text-md font-bold mt-2  mb-2">Product Management</h2>
                     <p className=' text-sm mb-1'>With Typescript, Express.js, PostgreSQL and Next.js. This website is used to manage warehouse inventory. (In development)</p>
                     <div className="flex justify-end mt-4">
