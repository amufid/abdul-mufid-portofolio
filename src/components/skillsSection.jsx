               ...
               <AnimatedSide from='left'>
                  ...
                  <div className="flex flex-wrap sm:flex-row mx-auto justify-center my-3">
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                        ...
                        <p className="text-center font-serif dark:text-slate-200 text-sm">Node.js</p>
                     </div>
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                        <img src="/images/express.png" alt="express" />
                        <p className="text-center font-serif dark:text-slate-200 text-sm">Express.js</p>
                     </div>
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                        <img src="/images/laravel.png" alt="laravel" />
                        <p className="text-center font-serif dark:text-slate-200 text-sm">Laravel</p>
                     </div>
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                     ...
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                        ...
                        <p className="text-center font-serif dark:text-slate-200 text-sm">MySQL</p>
                     </div>
               ...
               <AnimatedSide from='right'>
                  ...
                  <div className="flex flex-wrap sm:flex-row mx-auto justify-center my-3">
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                        ...
                        <p className="text-center font-serif dark:text-slate-200 text-sm">React.js</p>
                     </div>
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                        <img src="/images/nextjs.png" alt="nextjs" />
                        <p className="text-center font-serif dark:text-slate-200 text-sm">Next.js</p>
                     </div>
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
                        <img src="/images/vuejs.png" alt="nextjs" />
                        <p className="text-center font-serif dark:text-slate-200 text-sm">Vue.js</p>
                     </div>
                     <div className="mx-2 w-20 sm:w-24 my-5 rounded-md p-2 shadow-md hover:shadow-2xl hover:scale-105">
